...
const IND_CONFIG: { icon: React.ElementType; gradient: string; image?: string; imageBg?: string }[] = [
  ...
  { icon: Scale,             gradient: "from-slate-600 via-slate-700 to-slate-800" },
  { icon: HeartPulse,        gradient: "from-red-500 via-red-600 to-red-700" },
  { icon: HomeIcon,          gradient: "from-orange-500 via-orange-600 to-orange-700", image: "/industry-home-services.png", imageBg: "#1a1535" },
  { icon: Car,               gradient: "from-zinc-600 via-zinc-700 to-zinc-800" },
  { icon: Building2,         gradient: "from-teal-500 via-teal-600 to-teal-700" },
  { icon: Shield,            gradient: "from-indigo-500 via-indigo-600 to-indigo-700" },
  { icon: BarChart3,         gradient: "from-amber-500 via-amber-600 to-amber-700" },
  ...
  { icon: Hotel,             gradient: "from-cyan-500 via-cyan-600 to-cyan-700" },
  { icon: ShoppingCart,      gradient: "from-purple-500 via-purple-600 to-purple-700" },
  { icon: Sparkles,          gradient: "from-green-500 via-green-600 to-green-700" },
  { icon: Truck,             gradient: "from-yellow-500 via-yellow-600 to-yellow-700" },
  { icon: PawPrint,          gradient: "from-fuchsia-500 via-fuchsia-600 to-fuchsia-700" },
  { icon: Users,             gradient: "from-blue-600 via-blue-700 to-indigo-700" },
