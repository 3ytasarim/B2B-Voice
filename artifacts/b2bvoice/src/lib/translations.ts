...
export interface Translations {
  ...
  industries: { badge: string; heading: string; span: string; sub: string; items: { title: string; features: string[] }[] };
...
export const T: Record<Lang, Translations> = {
  en: {
    ...
    industries: {
      badge: "Industries", heading: "Custom AI Voice for", span: "every industry.", sub: "From healthcare to hospitality — B2BVoice adapts to any business, any workflow, any language.",
      items: [
        { title: "Real Estate", features: ["Lead Qualification", "Showing Requests", "Buyer & Seller Intake"] },
        { title: "Dental Clinics", features: ["Appointment Booking", "Patient Intake", "Treatment Questions"] },
        { title: "Hair Salons", features: ["Booking Support", "Pricing Questions", "Availability Check"] },
        { title: "Beauty & Med Spas", features: ["Consultation Requests", "Service Questions", "Appointment Booking"] },
        { title: "Law Firms", features: ["Client Intake", "Consultation Booking", "Case Type Routing"] },
        { title: "Medical Clinics", features: ["Patient Questions", "Appointment Requests", "Call Routing"] },
        { title: "Home Services", features: ["Service Requests", "Emergency Calls", "Job Scheduling"] },
        { title: "Automotive", features: ["Service Booking", "Price Inquiries", "Repair Updates"] },
        { title: "Property Management", features: ["Tenant Requests", "Maintenance Calls", "Viewing Requests"] },
        { title: "Insurance Agencies", features: ["Policy Questions", "Lead Qualification", "Claim Intake"] },
        { title: "Accounting & Tax", features: ["Client Intake", "Document Questions", "Appointment Scheduling"] },
        { title: "Fitness Studios", features: ["Membership Questions", "Trial Class Booking", "Schedule Info"] },
        { title: "Restaurants", features: ["Reservation Requests", "Menu Questions", "Opening Hours"] },
        { title: "Hotels & Hospitality", features: ["Booking Questions", "Guest Support", "Room Availability"] },
        { title: "E-Commerce", features: ["Order Questions", "Return Requests", "Product Support"] },
        { title: "Cleaning Services", features: ["Quote Requests", "Service Scheduling", "Customer Intake"] },
        { title: "Moving Companies", features: ["Quote Requests", "Move Details", "Availability Check"] },
        { title: "Veterinary Clinics", features: ["Appointment Requests", "Pet Intake", "Service Questions"] },
        { title: "Recruitment Agencies", features: ["Candidate Intake", "Interview Scheduling", "Job Questions"] },
        { title: "Education & Training", features: ["Course Questions", "Enrollment Support", "Consultation Booking"] },
      ],
    },
  ...
  de: {
    ...
    industries: {
      badge: "Branchen", heading: "KI-Sprachassistent für", span: "jede Branche.", sub: "Von Gesundheit bis Gastronomie – B2BVoice passt sich jedem Unternehmen und Workflow an.",
      items: [
        { title: "Immobilien", features: ["Lead-Qualifizierung", "Besichtigungsanfragen", "Käufer- & Verkäufer-Aufnahme"] },
        { title: "Zahnarztpraxen", features: ["Terminbuchung", "Patientenaufnahme", "Behandlungsfragen"] },
        { title: "Friseursalons", features: ["Buchungsunterstützung", "Preisfragen", "Verfügbarkeitscheck"] },
        { title: "Beauty & Med Spas", features: ["Beratungsanfragen", "Servicefragen", "Terminbuchung"] },
        { title: "Kanzleien", features: ["Mandantenaufnahme", "Beratungsbuchung", "Falltyp-Routing"] },
        { title: "Arztpraxen", features: ["Patientenfragen", "Terminanfragen", "Anrufweiterleitung"] },
        { title: "Haushaltsdienstleistungen", features: ["Serviceanfragen", "Notfallanrufe", "Jobplanung"] },
        { title: "Kfz-Service", features: ["Servicebuchung", "Preisanfragen", "Reparaturupdates"] },
        { title: "Hausverwaltung", features: ["Mieteranfragen", "Wartungsanrufe", "Besichtigungsanfragen"] },
        { title: "Versicherungen", features: ["Policenfragen", "Lead-Qualifizierung", "Schadensmeldung"] },
        { title: "Steuerberatung", features: ["Mandantenaufnahme", "Dokumentenfragen", "Terminplanung"] },
        { title: "Fitnessstudios", features: ["Mitgliedschaftsfragen", "Probestunden-Buchung", "Stundenpläne"] },
        { title: "Restaurants", features: ["Reservierungsanfragen", "Menüfragen", "Öffnungszeiten"] },
        { title: "Hotels & Gastronomie", features: ["Buchungsfragen", "Gästebetreuung", "Zimmerverfügbarkeit"] },
        { title: "E-Commerce", features: ["Bestellfragen", "Rückgabeanfragen", "Produktsupport"] },
        { title: "Reinigungsservice", features: ["Angebotserstellung", "Serviceplanung", "Kundenaufnahme"] },
        { title: "Umzugsunternehmen", features: ["Angebotserstellung", "Umzugsdetails", "Verfügbarkeitscheck"] },
        { title: "Tierarztpraxen", features: ["Terminanfragen", "Tieraufnahme", "Servicefragen"] },
        { title: "Personalvermittlung", features: ["Kandidatenaufnahme", "Interviewplanung", "Jobfragen"] },
        { title: "Bildung & Training", features: ["Kursfragen", "Anmeldung", "Beratungsbuchung"] },
      ],
    },
  ...
  es: {
    ...
    industries: {
      badge: "Sectores", heading: "Voz IA personalizada para", span: "cada sector.", sub: "De sanidad a hostelería — B2BVoice se adapta a cualquier negocio, flujo de trabajo e idioma.",
      items: [
        { title: "Inmobiliaria", features: ["Calificación de Leads", "Solicitudes de Visita", "Captación Compradores"] },
        { title: "Clínicas Dentales", features: ["Reserva de Citas", "Admisión de Pacientes", "Preguntas de Tratamiento"] },
        { title: "Peluquerías", features: ["Apoyo en Reservas", "Preguntas de Precios", "Verificar Disponibilidad"] },
        { title: "Beauty & Med Spas", features: ["Solicitudes de Consulta", "Preguntas de Servicio", "Reserva de Citas"] },
        { title: "Despachos de Abogados", features: ["Captación de Clientes", "Reserva de Consulta", "Enrutamiento de Casos"] },
        { title: "Clínicas Médicas", features: ["Preguntas de Pacientes", "Solicitudes de Citas", "Enrutamiento de Llamadas"] },
        { title: "Servicios del Hogar", features: ["Solicitudes de Servicio", "Llamadas de Emergencia", "Programación"] },
        { title: "Automoción", features: ["Reserva de Servicio", "Consultas de Precio", "Actualizaciones de Reparación"] },
        { title: "Gestión de Propiedades", features: ["Solicitudes de Inquilinos", "Llamadas de Mantenimiento", "Visitas"] },
        { title: "Seguros", features: ["Preguntas de Póliza", "Calificación de Leads", "Apertura de Siniestros"] },
        { title: "Asesoría Fiscal", features: ["Captación de Clientes", "Preguntas sobre Docs", "Programación de Citas"] },
        { title: "Gimnasios", features: ["Preguntas de Membresía", "Clase de Prueba", "Información de Horarios"] },
        { title: "Restaurantes", features: ["Solicitudes de Reserva", "Preguntas de Menú", "Horarios de Apertura"] },
        { title: "Hoteles & Hostelería", features: ["Preguntas de Reserva", "Atención al Huésped", "Disponibilidad"] },
        { title: "E-Commerce", features: ["Preguntas de Pedidos", "Solicitudes de Devolución", "Soporte de Producto"] },
        { title: "Servicios de Limpieza", features: ["Solicitudes de Presupuesto", "Programación", "Captación de Clientes"] },
        { title: "Empresas de Mudanzas", features: ["Solicitudes de Presupuesto", "Detalles de Mudanza", "Disponibilidad"] },
        { title: "Clínicas Veterinarias", features: ["Solicitudes de Citas", "Admisión de Mascotas", "Preguntas de Servicio"] },
        { title: "Agencias de Empleo", features: ["Captación de Candidatos", "Entrevistas", "Preguntas de Empleo"] },
        { title: "Educación y Formación", features: ["Preguntas de Cursos", "Inscripción", "Reserva de Consulta"] },
      ],
    },
